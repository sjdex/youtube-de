...
## @type: DataSource
## @args: [database = "youtube-de-raw-db", table_name = "raw_stats", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []

predicate_pushdown = "region in ('ca','gb','us')"

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "youtube-de-raw-db", table_name = "raw_stats", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://dexter-youtube-cleansed-useast1-dev/youtube/raw_stats"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path": "s3://dexter-youtube-cleansed-useast1-dev/youtube/raw_stats", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
job.commit()